...
int main() {
    ...
    //Étape 2  Conversion en Lab
    Mat lab;
    cvtColor(img, lab, COLOR_BGR2Lab);

    // Étape 3 : Extraction des pixels rouges 
    ...
    // inRange(bChannel, 120, 160, redMask);  // Exclusion des zones jaunes ou bleues
     ...
     // Étape 4 : Morphologie mathématique
    int k1 = 3, k2 = 7;
